    ...
    return (
      <div className="hero hero__container">
        ...
        <div className="hero__title">
          <img alt="The Wedding of Andreas & Mathilde" src="/img/headers/title@3x.png" srcSet="/img/headers/title.png, /img/headers/title@2x.png 2x, /img/headers/title@3x.png 3x" />
          <HeroDevider />
          <nav>
            <div className="links">
