    ...
    return (
      <div className="hero hero__container">
        ...
        <div className="hero__title">
          <img
            alt="The Wedding of Andreas & Mathilde"
            src="/img/headers/title@3x.png"
            srcSet="/img/headers/title.png, /img/headers/title@2x.png 2x, /img/headers/title@3x.png 3x"
          />
          <HeroDevider />
          <nav>
            <div className="links">
        ...
        <aside className="hero__social">
          ...
          <Link
            href="https://www.instagram.com/ajarbol/"
            target="_blank"
            rel="noopener"
          >
            <svg
              alt="Andreas Instagram profile"
              width="25"
              height="25"
              xmlns="http://www.w3.org/2000/svg"
            >
          ...
          <Link
            href="https://github.com/ajarbol/"
            target="_blank"
            rel="noopener"
          >
            <svg
              alt="Andreas Github profile"
              width="25px"
              height="25px"
              viewBox="0 0 25 25"
              version="1.1"
