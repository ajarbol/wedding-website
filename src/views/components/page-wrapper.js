...
export default ({ className, children, ...props }) => (
  <article className={`page ${className}`} {...props}>
    {(isIE || isEdge) ? (
      <Link href="/" className="ie_back" ariaLabel="Close page">
        <svg viewBox="0 0 29 44" version="1.1" xmlns="http://www.w3.org/2000/svg">
            <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                <g transform="translate(-956.000000, -40.000000)" stroke-width="3">
    ...
    ) : <Link href="/" className="hot_corner" ariaLabel="Close page" />}
